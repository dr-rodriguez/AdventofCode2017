...
(the first element in the list), a skip size (which starts at 0),
...
my_input = np.array([int(s) for s in "183,0,31,146,254,240,223,150,2,206,161,1,255,232,199,88".split(',')])
test_input = [3, 4, 1, 5]
...
#   print(arr, ind, arr[ind], skip, v)
    ...
    skip += 1
print(arr, ind, arr[ind], skip, v)
print('answer: {}'.format(arr[0]*arr[1]))
...
This will allow you to handle arbitrary ASCII strings, and it also ensures that your input lengths are never
larger than 255. For example, if you are given 1,2,3, you should convert it to the
...
knot_hash('183,0,31,146,254,240,223,150,2,206,161,1,255,232,199,88')
